...
/obj/machinery/mineral/mint/Bumped(var/atom/movable/A)
	var/obj/item/stack/O = A
	if(istype(O))
		var/processed = 1
...
/obj/machinery/mineral/mint/attack_hand(user as mob)
	...
	var/datum/browser/popup = new(usr, "mint", "Mint Console", 400, 500)
