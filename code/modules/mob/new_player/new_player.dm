...
/mob/proc/import_spawn()
	...
	to_chat(newchar, "You find a book at your feet. 'Guide to Sycorax Quadrant'.")
	to_chat(newchar, "You've been in this situation before, but on a different station. What new stories does the Sycorax Quadrant hold for you?")
