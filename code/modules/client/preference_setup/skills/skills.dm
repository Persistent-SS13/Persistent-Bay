...
/datum/category_item/player_setup_item/welcome/content()
	...
	. += "<br><br>Persistence is a collaborative project that is developed by an entire community of people. If you are intrested in joining us you can visit <a href='https://persistentss13.com/forum/'>our forums here</a> or <a href='https://discord.gg/UUpHSPp'>our discord here</a>, plus you can find <a href='https://persistentss13.com/wiki'>a wiki here.</a>"
