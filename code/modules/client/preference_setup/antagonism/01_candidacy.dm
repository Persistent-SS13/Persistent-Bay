...
/datum/category_item/player_setup_item/antagonism/candidacy/content(var/mob/user)
	...
	// 		. += "<span class='linkOn'>High</span> <a href='?src=\ref[src];del_special=[antag.role_type]'>Low</a> <a href='?src=\ref[src];add_never=[GLOB.antag.role_type]'>Never</a></br>"
	// 	else if(antag.role_type in pref.sometimes_be_special_role)
	// 		. += "<a href='?src=\ref[src];add_special=[GLOB.antag.role_type]'>High</a> <span class='linkOn'>Low</span> <a href='?src=\ref[src];add_never=[GLOB.antag.role_type]'>Never</a></br>"
	// 	else
	// 		. += "<a href='?src=\ref[src];add_special=[GLOB.antag.role_type]'>High</a> <a href='?src=\ref[src];del_special=[GLOB.antag.role_type]'>Low</a> <span class='linkOn'>Never</span></br>"
	// 	. += "</td></tr>"
