...
/obj/item/clothing/accessory/terran/rank/navy
	...
	icon = 'code/modules/torch/icons/obj/obj_accessories_terran.dmi'
	accessory_icons = list(slot_w_uniform_str = 'code/modules/torch/icons/mob/onmob_accessories_terran.dmi', slot_wear_suit_str = 'code/modules/torch/icons/mob/onmob_accessories_terran.dmi')
