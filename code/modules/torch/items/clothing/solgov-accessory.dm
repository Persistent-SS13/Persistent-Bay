/obj/item/clothing/accessory/solgov
	...
	icon = 'code/modules/torch/icons/obj/obj_accessories_solgov.dmi'
...
/obj/item/clothing/accessory/ribbon/solgov/marksman
	...
	desc = "A military decoration awarded to members of the SCG for good marksmanship scores in training. Common in the days of DAM_ENERGY weapons."
	icon_state = "ribbon_marksman"
...
/obj/item/clothing/accessory/armor/tag/solgov
	...
	icon_override = 'code/modules/torch/icons/obj/obj_accessories_solgov.dmi'
	icon = 'code/modules/torch/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'code/modules/torch/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'code/modules/torch/icons/mob/onmob_accessories_solgov.dmi')
	icon_state = "solflag"
