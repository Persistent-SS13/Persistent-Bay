...
/obj/machinery/media/jukebox
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Snuckey's Muzak", 'sound/music/jukebox/09 - Snuckey's Greatest Muzaks #2.mid', "Pleasent"),
		new/datum/track("Red Liccorice Candy", 'sound/music/jukebox/11 - Snuckey's Greatest Muzaks #4.mid', "Pleasent"),
		new/datum/track("Doug, The Moleman", 'sound/music/jukebox/17 - Doug, The Moleman.mid', "Moody"),
		new/datum/track("I'm a Trout, Stupid!", 'sound/music/jukebox/21 - I'm A Trout, Stupid!.mid', "Country"),
