...
/datum/map/torch/default_internal_channels()
	return list(
		...
		num2text(ENG_FREQ)   = list(core_access_engineering_programs, core_access_engineering_programs),
		num2text(MED_FREQ)   = list(access_medical_equip),
		num2text(MED_I_FREQ) = list(access_medical_equip),
		num2text(SEC_FREQ)   = list(access_security),
		num2text(SEC_I_FREQ) = list(access_security),
		num2text(SCI_FREQ)   = list(access_tox,core_access_science_programs,access_xenobiology),
