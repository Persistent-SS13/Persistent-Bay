...
/obj/item/clothing/suit/storage/hooded/wintercoat/solgov
	...
	icon = 'code/modules/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'code/modules/torch/icons/mob/onmob_suit_solgov.dmi')
	armor = list(DAM_BLUNT = 25, DAM_CUT = 25, DAM_PIERCE = 20, DAM_BULLET = 10, DAM_LASER = 5, DAM_ENERGY = 10, DAM_BOMB = 20, DAM_BIO = 0, DAM_RADS = 10)
...
/obj/item/clothing/suit/storage/hooded/wintercoat/solgov/army
	...
	icon_state = "coatar"
	armor = list(DAM_BLUNT = 30, DAM_CUT = 30, DAM_PIERCE = 25, DAM_BULLET = 10, DAM_LASER = 10, DAM_ENERGY = 15, DAM_BOMB = 20, DAM_BIO = 0, DAM_RADS = 0)
	valid_accessory_slots = list(ACCESSORY_SLOT_INSIGNIA,ACCESSORY_SLOT_RANK)

/obj/item/clothing/suit/storage/hooded/wintercoat/solgov/fleet
	name = "fleet winter coat"
	icon_state = "coatfl"
	armor = list(DAM_BLUNT = 20, DAM_CUT = 20, DAM_PIERCE = 15, DAM_BULLET = 10, DAM_LASER = 10, DAM_ENERGY = 20, DAM_BOMB = 20, DAM_BIO = 0, DAM_RADS = 10)
...
/obj/item/clothing/suit/space/void/engineering/alt/sol
	...
	item_icons = list(slot_wear_suit_str = 'code/modules/torch/icons/mob/onmob_suit_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'code/modules/torch/icons/mob/unathi/onmob_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code/modules/torch/icons/mob/skrell/onmob_suit_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'code/modules/torch/icons/obj/unathi/obj_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code/modules/torch/icons/obj/skrell/obj_suit_solgov_skrell.dmi',
		)
