/obj/mecha/combat/gygax
	...
	health = 300
	deflect_chance = 15
	damage_absorption = list(DAM_BLUNT = 0.75, DAM_CUT = 0.75, DAM_PIERCE= 0.7, DAM_BURN = 1, DAM_BULLET = 0.8, DAM_LASER = 0.7, DAM_ENERGY = 0.85, DAM_BOMB = 1)
...
/obj/mecha/combat/gygax/dark
	...
	health = 400
	deflect_chance = 25
	damage_absorption = list(DAM_BLUNT = 0.6, DAM_CUT = 0.6, DAM_PIERCE = 0.55, DAM_BURN = 0.8, DAM_BULLET = 0.6, DAM_LASER = 0.5, DAM_ENERGY = 0.65, DAM_BOMB = 0.8)
