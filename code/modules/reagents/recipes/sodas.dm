...
/datum/chemical_reaction/space_cola
	...
	result_amount = 5
	required_reagents = list(/datum/reagent/drink/sodawater = 2, /datum/reagent/sugar = 4, /datum/reagent/nutriment/molasses = 1)
	mix_message = "The clear soda water mixes with the sugar and thick molasses to form a slightly thicker and darker liquid."

/datum/chemical_reaction/spacemountainwind
	result = /datum/reagent/drink/spacemountainwind
	result_amount = 5
	required_reagents = list(/datum/reagent/drink/sodawater = 2, /datum/reagent/drink/juice/orange = 1, /datum/reagent/drink/juice/lime = 1, /datum/reagent/drink/juice/lemon = 1 )
...
/datum/chemical_reaction/lemon_lime
	...
	result_amount = 6
	required_reagents = list(/datum/reagent/drink/sodawater = 2,  /datum/reagent/drink/juice/lime = 2, /datum/reagent/drink/juice/lemon = 2)
...
/datum/chemical_reaction/space_up
	...
	result_amount = 3
	required_reagents = list(/datum/reagent/drink/sodawater = 2, /datum/reagent/frostoil = 1) //helps keep your cool
...
/datum/chemical_reaction/thirteenloko
	...
	result_amount = 12
	required_reagents = list(/datum/reagent/drink/sodawater = 4, /datum/reagent/drink/coffee = 4, /datum/reagent/ethanol/grog = 4)
