...
/turf/simulated/mineral/random
	...
	var/mineralSpawnChanceList = list("Pitchblende" = 5, "Platinum" = 5, "Lead" = 6, "Tungsten" = 2, "Hematite" = 35, "Copper" = 35, "Aluminum" = 25, "Sulfur" = 20, "Tin" = 20, "Zinc" = 20, "Graphene" = 35, "Salt" = 20, "Diamond" = 1, "Gold" = 5, "Silver" = 5, "Phoron" = 10)
...
/turf/simulated/mineral/random/high_chance
	...
	mineralSpawnChanceList = list("Pitchblende" = 10, "Platinum" = 10, "Lead" = 12, "Tungsten" = 4, "Hematite" = 20, "Copper" = 20, "Aluminum" = 15, "Sulfur" = 10, "Tin" = 10, "Zinc" = 10, "Graphene" = 20, "Salt" = 10, "Diamond" = 2, "Gold" = 10, "Silver" = 10, "Phoron" = 20)
