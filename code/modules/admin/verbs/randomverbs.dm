...
/client/proc/cmd_admin_sycorax_narrate() // Allows administrators to fluff events a little easier -- TLE
	set category = "Special Verbs"
	set name = "SYCO Speak"
	set desc = "Narrate to everyone."
	...
	var/result
	var/message = input("Message:", text("Enter the text you want SYCO to say. This will be broadcast to both the entire server and the discord.")) as null|text
	if (!message)
		return
