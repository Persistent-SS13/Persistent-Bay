...
/datum/job/hop
	...
	access = list(access_security, access_brig, access_armory, access_forensics_lockers,
			            ...
			            access_all_personal_lockers, access_chapel_office, access_tech_storage, core_access_engineering_programs, access_bar, access_janitor, access_crematorium, core_access_science_programs,
			            ...
			            access_medical_equip, access_solgov_crew, core_access_science_programs_engineering, access_emergency_armory, access_gun, access_expedition_shuttle, access_guppy,
...
/datum/job/chief_engineer
	...
	access = list(access_engine, core_access_engineering_programs, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
			            ...
			            access_tech_storage, core_access_science_programs, core_access_engineering_programs, access_janitor, access_construction,
			            access_network, access_ce, access_RC_announce, access_keycard_auth, access_tcomsat,
			            access_solgov_crew, core_access_science_programs_engineering, access_seneng, access_hangar, core_access_science_programs)
...
/datum/job/roboticist
	...
	access = list(core_access_science_programs, core_access_science_programs_engineering, access_tech_storage, access_morgue, access_medical, core_access_science_programs_engineering, access_solgov_crew)
	minimal_access = list()
