/obj/machinery/alarm/sycorax
	req_access_faction = SYCORAX_FACTION_CITIZEN
	faction_uid = SYCORAX_FACTION_CITIZEN

/obj/machinery/alarm/sycorax/cold
	target_temperature = T0C+4

/obj/machinery/alarm/sycorax/nobreach
	breach_detection = FALSE

/obj/machinery/alarm/sycorax/monitor
	report_danger_level = FALSE
	breach_detection = FALSE

/obj/machinery/alarm/sycorax/server/New()
	..()
