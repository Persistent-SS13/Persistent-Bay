...
function run_code_tests {
    ...
    run_test "check changelog example unchanged" "md5sum -c - <<< '6c5bad2bd567d160f95f1a665793bc58 *html/changelogs/example.yml'"
...
function run_byond_tests {
    ...
    run_test "check globals unchanged" "md5sum -c - <<< 'cf6822b085cbe8d16bae907d9e917cdd *code/_helpers/global_access.dm'"
