...
/obj/item/organ/internal/augment/active/polytool/engineer
	...
	paths = list(
		/obj/item/weapon/tool/screwdriver/finger,
		/obj/item/weapon/tool/wrench/finger,
		/obj/item/weapon/tool/weldingtool/finger,
		/obj/item/weapon/tool/crowbar/finger,
		/obj/item/weapon/tool/wirecutters/finger,
...
/obj/item/weapon/tool/weldingtool/finger/on_update_icon()
...
/obj/item/weapon/tool/wirecutters/finger/Initialize()
	. = ..()
...
/obj/item/weapon/tool/screwdriver/finger/Initialize()
	. = ..()
	icon_state = initial(icon_state)
	item_state = initial(item_state)
...
/obj/item/weapon/tool/crowbar/finger/Initialize()
	. = ..()
	icon_state = initial(icon_state)
	item_state = initial(item_state)
...
/obj/item/weapon/tool/wrench/finger/Initialize()
	. = ..()
	icon_state = initial(icon_state)
	item_state = initial(item_state)
