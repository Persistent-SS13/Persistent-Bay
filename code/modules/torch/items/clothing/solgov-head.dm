...
/obj/item/clothing/head/helmet/space/void/engineering/alt/sol
	...
	item_icons = list(slot_head_str = 'code/modules/torch/icons/mob/onmob_head_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'code/modules/torch/icons/mob/unathi/onmob_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code/modules/torch/icons/mob/skrell/onmob_head_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'code/modules/torch/icons/obj/unathi/obj_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'code/modules/torch/icons/obj/skrell/obj_head_solgov_skrell.dmi',
		)
