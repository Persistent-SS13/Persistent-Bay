/obj/machinery/power/supermatter
	description_info = "When energized by a laser (or something hitting it), it emits radiation and heat.  If the temperature reaches above 7000 kelvin, it will send an alert and start taking damage. \
