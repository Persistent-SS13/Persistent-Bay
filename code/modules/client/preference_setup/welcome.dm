...
/datum/category_item/player_setup_item/welcome/content()
	...
	. += "An elected government creates laws that hires police to enforce them while collecting taxes from private businesses that are competing in the lower floors of the Sycorax Station Space Station.<br><br>"
	...
	. += "Relax and have fun on your first day. You are a new immigrant to Sycorax Station and you might need to spend some time looking for a job or some friends.<br>"
