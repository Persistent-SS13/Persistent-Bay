	...
	for(var/i=0,i<chunk_size,i++)
		for(var/j=0,j<chunk_size,j++)
			...
			if(tmp_cell < rare_val)      // Surface metals.
				...
				T.resources[MATERIAL_ICES_ACETONE] =		rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_AMONIA] =			rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_CARBON_DIOXIDE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_HYDROGEN] = 		rand(RESOURCE_MID_MIN,  RESOURCE_MID_MAX)
				T.resources[MATERIAL_ICES_METHANE] =		rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_NITROGEN] =		rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_SULFUR_DIOXIDE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_WATER] =			rand(RESOURCE_HIGH_MIN,	RESOURCE_HIGH_MAX)
				...
				T.resources[MATERIAL_DEUTERIUM] =			0
				T.resources[MATERIAL_TRITIUM] =				0
				T.resources[MATERIAL_ICES_ACETONE] =		rand(RESOURCE_HIGH_MIN, RESOURCE_HIGH_MAX)
				T.resources[MATERIAL_ICES_AMONIA] =			rand(RESOURCE_HIGH_MIN, RESOURCE_HIGH_MAX)
				T.resources[MATERIAL_ICES_CARBON_DIOXIDE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_HYDROGEN] = 		rand(RESOURCE_HIGH_MIN, RESOURCE_HIGH_MAX)
				T.resources[MATERIAL_ICES_METHANE] =		rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_NITROGEN] =		rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_SULFUR_DIOXIDE] = rand(RESOURCE_LOW_MIN,  RESOURCE_LOW_MAX)
				T.resources[MATERIAL_ICES_WATER] =			rand(RESOURCE_LOW_MIN,	RESOURCE_LOW_MAX)
